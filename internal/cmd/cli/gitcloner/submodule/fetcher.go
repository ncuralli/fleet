...
//go:generate mockgen --build_flags=--mod=mod -source=fetcher.go  -destination=../../../../mocks/git_submodule_mock.go  -package=mocks github.com/rancher/fleet/internal/cmd/cli/gitcloner/submodule Strategy,CapabilityDetector
