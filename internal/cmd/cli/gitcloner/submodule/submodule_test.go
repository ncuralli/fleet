...
func TestSubmoduleUpdater_FetchCalledWithCorrectHash(t *testing.T) {
	...
	// Ignoriamo l'errore perché il submodule repo non esiste realmente
...
func TestSubmoduleUpdater_ContextCancellation(t *testing.T) {
	...
	// Estraiamo i submodules per chiamare UpdateContext direttamente
